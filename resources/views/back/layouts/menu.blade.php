        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse @if(Request::segment(2)=="articles") show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    ...
                    <a class="collapse-item @if(Request::segment(2)=="articles" && !Request::segment(3)) active @endif" href="{{route('admin.articles.index')}}">Show All Articles</a>
                        <a class="collapse-item @if(Request::segment(2)=="articles" && Request::segment(3)=="create") active @endif" href="{{route('admin.articles.create')}}">Add Articles</a>
                    </div>
                </div>
            </li>
